...
class SeminarAdmin(admin.ModelAdmin):
    list_display = ('date_start', 'title_short', 'organization_name', 'registration_number', 'company_badge', 'count_certificates')
...
class CertificateAdmin(admin.ModelAdmin):
    list_display = ('full_name', 'company_badge', 'get_org_name', 'certificate_number', 'seminar_link', 'link_print', 'link_web')
